...
signal_sheet <- bind_rows(
  ...
  tibble::tribble(
    ...
    "covid_hosp_facility", "is_corrected", "If a fields has been altered from its raw, submitted value to smooth out data anomalies, this flag will be set to 'true'. This processing is done by the data provider, not by Delphi", TRUE,
    "covid_hosp_facility", "previous_day_admission_adult_covid_confirmed_7_day_coverage", "Number of times in the 7 day period that the facility reported the number of patients admitted to adult inpatient bed on previous calendar day with confirmed COVID-19", TRUE,
    "covid_hosp_facility", "previous_day_admission_adult_covid_suspected_7_day_coverage", "Number of times in the 7 day period that the facility reported the number of patients admitted to adult inpatient bed on previous calendar day with suspected COVID-19", TRUE,
    "covid_hosp_facility", "previous_day_admission_pediatric_covid_confirmed_7_day_coverage", "Number of times in the 7 day period that the facility reported the number of pediatric patients admitted to an inpatient bed on previous calendar day with confirmed COVID-19", TRUE,
    "covid_hosp_facility", "previous_day_admission_pediatric_covid_suspected_7_day_coverage", "Number of times in the 7 day period that the facility reported the number of pediatric patients admitted to inpatient bed on previous calendar day with suspected COVID-19", TRUE,
    "covid_hosp_facility", "previous_week_patients_covid_vaccinated_doses_all_7_day", "The number reported of patients who received the final dose in a COVID-19 vaccination series. (Collected on Wednesdays only)", TRUE,
    "covid_hosp_facility", "previous_week_patients_covid_vaccinated_doses_all_7_day_sum", NA_character_, TRUE,
    "covid_hosp_facility", "previous_week_patients_covid_vaccinated_doses_one_7_day", "The number reported of patients who received the first dose of a COVID-19 vaccine that is administered in a multi-dose series. (Collected on Wednesdays only)", TRUE,
    "covid_hosp_facility", "previous_week_patients_covid_vaccinated_doses_one_7_day_sum", NA_character_, TRUE,
    "covid_hosp_facility", "previous_week_personnel_covid_vaccd_doses_administered_7_day", NA_character_, TRUE,
    "covid_hosp_facility", "previous_week_personnel_covid_vaccd_doses_administered_7_day_sum", NA_character_, TRUE,
    "covid_hosp_facility", "total_personnel_covid_vaccinated_doses_all_7_day", "The current number reported of healthcare personnel who have received a complete series of a COVID-19vaccination.Includes those who have received all doses in a multi-dose series as well as those who received a single-dose vaccine. (Collected on Wednesdays only)", TRUE,
    "covid_hosp_facility", "total_personnel_covid_vaccinated_doses_all_7_day_sum", NA_character_, TRUE,
    "covid_hosp_facility", "total_personnel_covid_vaccinated_doses_none_7_day", "The number reported of healthcare personnel who have not yet received a single vaccine dose. (Collected on Wednesdays only)", TRUE,
    "covid_hosp_facility", "total_personnel_covid_vaccinated_doses_none_7_day_sum", NA_character_, TRUE,
    "covid_hosp_facility", "total_personnel_covid_vaccinated_doses_one_7_day", "The current number reported of healthcare personnel who have received at least one dose of COVID-19 vaccination that is administered in a multi-dose series. This field is meant to represent those who have begun but not completed the vaccination process. Does not include those who received a single-dose vaccine in this field. (Collected on Wednesdays only)", TRUE,
    "covid_hosp_facility", "total_personnel_covid_vaccinated_doses_one_7_day_sum", NA_character_, TRUE,
    ...
    "paho_dengue", "release_date", "The date when this record was first published by PAHO", FALSE,
    ...
    "twitter", "epiweek", "The date a tweet was made", FALSE,
    "twitter", "location", "Two-letter U.S. state abbreviation", FALSE,
