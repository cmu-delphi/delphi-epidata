...
class UnitTests(unittest.TestCase):
  ...
  def test_upload_archive(self):
    ...
    mock_database.insert_or_update_batch.return_value = 2
    mock_csv_importer = MagicMock()
    ...
    self.assertEqual(mock_database.insert_or_update_batch.call_count, 2)
    call_args_list = mock_database.insert_or_update_batch.call_args_list
  ...
  def test_database_exception_is_handled(self):
    ...
    data_dir = 'data_dir'
    mock_database = MagicMock()
    mock_database.insert_or_update_batch.side_effect = Exception('testing')
    mock_csv_importer = MagicMock()
    ...
    self.assertTrue(mock_database.insert_or_update_batch.called)
