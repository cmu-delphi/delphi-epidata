...
from delphi.epidata.acquisition.covid_hosp.common.utils import CovidHospException, Utils
...
class UtilsTests(unittest.TestCase):
    ...
    def test_issues_to_fetch(self):
        ...
        self.assertEqual(
            issues,
            {
                ...
                date(2021, 3, 15): [
                    ("c", pd.Timestamp("2021-03-15 00:00:00")),
    ...
    def test_run_skip_old_dataset(self):
        ...
        mock_network.fetch_metadata.return_value = self.test_utils.load_sample_metadata()
