...
class DatabaseTests(unittest.TestCase):
  ...
  def test_insert_dataset(self):
    ...
    expected_query_values = (
        0, sentinel.issue, 'WY', 8, 21, 2, 7, 22, 2, 5, 29, 1729, 31, 856,
        31, 198, 29, 26, 31, 15, 29, 0, 29, 0, 29, 58, 31, 32, 29, 32, 31,
        196, 29, 189, 31, 2, 29, 2, 29, 137, 31, 0.4950838635049161, 31,
