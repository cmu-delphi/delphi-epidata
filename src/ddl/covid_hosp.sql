...
CREATE TABLE `covid_hosp_facility` (
  ...
  `staffed_icu_adult_patients_confirmed_suspected_covid_7_day_sum` INT,
  ...
  `total_adult_patients_hosp_confirmed_susp_covid_7_day_coverage` INT,
  ...
  `total_patients_hospitalized_confirmed_influenza_covid_7_day_sum` INT,
  `total_pediatric_patients_hosp_confirmd_susp_covid_7_day_coverage` INT,
  `total_pediatric_patients_hosp_confirmed_covid_7_day_coverage` INT,
