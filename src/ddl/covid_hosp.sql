...
/*
`covid_hosp_state_daily` stores the versioned "state daily" dataset.
...
| staffed_adult_icu_bed_occupancy                                  | int(11) | YES  |     | NULL    |                |
| staffed_adult_icu_bed_occupancy_coverage                         | int(11) | YES  |     | NULL    |                |
| staffed_icu_adult_patients_confirmed_and_suspected_covid         | int(11) | YES  |     | NULL    |                |
| staffed_icu_adult_patients_confirmed_suspected_covid_coverage    | int(11) | YES  |     | NULL    |                |
| staffed_icu_adult_patients_confirmed_covid                       | int(11) | YES  |     | NULL    |                |
| staffed_icu_adult_patients_confirmed_covid_coverage              | int(11) | YES  |     | NULL    |                |
| total_adult_patients_hospitalized_confirmed_and_suspected_covid  | int(11) | YES  |     | NULL    |                |
| total_adult_patients_hosp_confirmed_suspected_covid_coverage     | int(11) | YES  |     | NULL    |                |
| total_adult_patients_hospitalized_confirmed_covid                | int(11) | YES  |     | NULL    |                |
| total_adult_patients_hospitalized_confirmed_covid_coverage       | int(11) | YES  |     | NULL    |                |
| total_pediatric_patients_hospitalized_confirmed_suspected_covid  | int(11) | YES  |     | NULL    |                |
| total_pediatric_patients_hosp_confirmed_suspected_covid_coverage | int(11) | YES  |     | NULL    |                |
| total_pediatric_patients_hospitalized_confirmed_covid            | int(11) | YES  |     | NULL    |                |
| total_pediatric_patients_hospitalized_confirmed_covid_coverage   | int(11) | YES  |     | NULL    |                |
| total_staffed_adult_icu_beds                                     | int(11) | YES  |     | NULL    |                |
| total_staffed_adult_icu_beds_coverage                            | int(11) | YES  |     | NULL    |                |
| inpatient_beds_utilization                                       | double  | YES  |     | NULL    |                |
| inpatient_beds_utilization_coverage                              | int(11) | YES  |     | NULL    |                |
...
| adult_icu_bed_utilization_numerator                              | int(11) | YES  |     | NULL    |                |
| adult_icu_bed_utilization_denominator                            | int(11) | YES  |     | NULL    |                |
| reporting_cutoff_start                                           | int(11) | NO   |     | NULL    |                |
+------------------------------------------------------------------+---------+------+-----+---------+----------------+
...
`total_adult_patients_hosp_confirmed_suspected_covid_coverage`
`total_pediatric_patients_hospitalized_confirmed_and_suspected_covid` ->
`total_pediatric_patients_hospitalized_confirmed_suspected_covid`
`total_pediatric_patients_hospitalized_confirmed_and_suspected_covid_coverage` ->
`total_pediatric_patients_hosp_confirmed_suspected_covid_coverage`
...
NOTE: the following data dictionary is copied from
https://healthdata.gov/covid-19-reported-patient-impact-and-hospital-capacity-state-data-dictionary
version entitled "Sun, 12/13/2020 - 22:28".
...
- `hospital_onset_covid`
  Total current inpatients with onset of suspected or laboratory-confirmed COVID-19
  fourteen or more days after admission for a condition other than COVID-19 in this state.
- `hospital_onset_covid_coverage`
  Number of hospitals reporting "hospital_onset_covid" in this state
- `inpatient_beds`
  Reported total number of staffed inpatient beds including all overflow and
  surge/expansion beds used for inpatients (includes all ICU beds) in this state
- `inpatient_beds_coverage`
  Number of hospitals reporting "inpatient_beds" in this state
- `inpatient_beds_used`
  Reported total number of staffed inpatient beds that are occupied in this state
- `inpatient_beds_used_coverage`
  Number of hospitals reporting "inpatient_beds_used" in this state
- `inpatient_beds_used_covid`
  Reported patients currently hospitalized in an inpatient bed who have suspected or
  confirmed COVID-19 in this state
- `inpatient_beds_used_covid_coverage`
  Number of hospitals reporting "inpatient_beds_used_covid" in this state
- `previous_day_admission_adult_covid_confirmed`
  Number of patients who were admitted to an adult inpatient bed on the previous calendar
  day who had confirmed COVID-19 at the time of admission in this state
- `previous_day_admission_adult_covid_confirmed_coverage`
  Number of hospitals reporting "previous_day_admission_adult_covid_confirmed" in this state
- `previous_day_admission_adult_covid_suspected`
  Number of patients who were admitted to an adult inpatient bed on the previous calendar
  day who had suspected COVID-19 at the time of admission in this state
- `previous_day_admission_adult_covid_suspected_coverage`
  Number of hospitals reporting "previous_day_admission_adult_covid_suspected" in this state
- `previous_day_admission_pediatric_covid_confirmed`
  Number of pediatric patients who were admitted to an inpatient bed, including NICU, PICU,
  newborn, and nursery, on the previous calendar day who had confirmed COVID-19 at the time
  of admission in this state
- `previous_day_admission_pediatric_covid_confirmed_coverage`
  Number of hospitals reporting "previous_day_admission_pediatric_covid_confirmed" in this state
- `previous_day_admission_pediatric_covid_suspected`
  Number of pediatric patients who were admitted to an inpatient bed, including NICU, PICU,
  newborn, and nursery, on the previous calendar day who had suspected COVID-19 at the time
  of admission in this state
- `previous_day_admission_pediatric_covid_suspected_coverage`
  Number of hospitals reporting "previous_day_admission_pediatric_covid_suspected" in this state
- `staffed_adult_icu_bed_occupancy`
  Reported total number of staffed inpatient adult ICU beds that are occupied in this state
- `staffed_adult_icu_bed_occupancy_coverage`
  Number of hospitals reporting "staffed_adult_icu_bed_occupancy" in this state
- `staffed_icu_adult_patients_confirmed_and_suspected_covid`
  Reported patients currently hospitalized in an adult ICU bed who have suspected or confirmed
  COVID-19 in this state
- `staffed_icu_adult_patients_confirmed_and_suspected_covid_coverage`
  Number of hospitals reporting "staffed_icu_adult_patients_confirmed_and_suspected_covid" in
  this state
- `staffed_icu_adult_patients_confirmed_covid`
  Reported patients currently hospitalized in an adult ICU bed who have confirmed COVID-19 in
  this state
- `staffed_icu_adult_patients_confirmed_covid_coverage`
  Number of hospitals reporting "staffed_icu_adult_patients_confirmed_covid" in this state
- `total_adult_patients_hospitalized_confirmed_and_suspected_covid`
  Reported patients currently hospitalized in an adult inpatient bed who have laboratory-confirmed
  or suspected COVID-19. This include those in observation beds.
- `total_adult_patients_hospitalized_confirmed_and_suspected_covid_coverage`
  Number of hospitals reporting "total_adult_patients_hospitalized_confirmed_and_suspected_covid"
  in this state
- `total_adult_patients_hospitalized_confirmed_covid`
  Reported patients currently hospitalized in an adult inpatient bed who have laboratory-confirmed
  COVID-19. This include those in observation beds.
- `total_adult_patients_hospitalized_confirmed_covid_coverage`
  Number of hospitals reporting "total_adult_patients_hospitalized_confirmed_covid" in this state
- `total_pediatric_patients_hospitalized_confirmed_and_suspected_covid`
  Reported patients currently hospitalized in a pediatric inpatient bed, including NICU, newborn,
  and nursery, who are suspected or laboratory-confirmed-positive for COVID-19. This include those
  in observation beds.
- `total_pediatric_patients_hospitalized_confirmed_and_suspected_covid_coverage`
  Number of hospitals reporting "total_pediatric_patients_hospitalized_confirmed_and_suspected_covid"
  in this state
- `total_pediatric_patients_hospitalized_confirmed_covid`
  Reported patients currently hospitalized in a pediatric inpatient bed, including NICU,
  newborn, and nursery, who are laboratory-confirmed-positive for COVID-19. This include
  those in observation beds.
- `total_pediatric_patients_hospitalized_confirmed_covid_coverage`
  Number of hospitals reporting "total_pediatric_patients_hospitalized_confirmed_covid" in this state
- `total_staffed_adult_icu_beds`
  Reported total number of staffed inpatient adult ICU beds in this state
- `total_staffed_adult_icu_beds_coverage`
  Number of hospitals reporting "total_staffed_adult_icu_beds" in this state
- `inpatient_beds_utilization`
  Percentage of inpatient beds that are being utilized in this state. This number only accounts for
  hospitals in the state that report both "inpatient_beds_used" and "inpatient_beds" fields.
- `inpatient_beds_utilization_coverage`
  Number of hospitals reporting both "inpatient_beds_used" and "inpatient_beds"
- `inpatient_beds_utilization_numerator`
  Sum of "inpatient_beds_used" for hospitals reporting both "inpatient_beds_used" and "inpatient_beds"
- `inpatient_beds_utilization_denominator`
  Sum of "inpatient_beds" for hospitals reporting both "inpatient_beds_used" and "inpatient_beds"
- `percent_of_inpatients_with_covid`
  Percentage of inpatient population who have suspected or confirmed COVID-19 in this state. This
  number only accounts for hospitals in the state that report both "inpatient_beds_used_covid"
  and "inpatient_beds_used" fields.
- `percent_of_inpatients_with_covid_coverage`
  Number of hospitals reporting both "inpatient_beds_used_covid" and "inpatient_beds_used".
- `percent_of_inpatients_with_covid_numerator`
  Sum of "inpatient_beds_used_covid" for hospitals reporting both "inpatient_beds_used_covid"
  and "inpatient_beds_used".
- `percent_of_inpatients_with_covid_denominator`
  Sum of "inpatient_beds_used" for hospitals reporting both "inpatient_beds_used_covid" and
  "inpatient_beds_used".
- `inpatient_bed_covid_utilization`
  Percentage of total (used/available) inpatient beds currently utilized by patients who have
  suspected or confirmed COVID-19 in this state. This number only accounts for hospitals in the
  state that report both "inpatient_beds_used_covid" and "inpatient_beds" fields.
- `inpatient_bed_covid_utilization_coverage`
  Number of hospitals reporting both "inpatient_beds_used_covid" and "inpatient_beds".
- `inpatient_bed_covid_utilization_numerator`
  Sum of "inpatient_beds_used_covid" for hospitals reporting both "inpatient_beds_used_covid" and
  "inpatient_beds".
- `inpatient_bed_covid_utilization_denominator`
  Sum of "inpatient_beds" for hospitals reporting both "inpatient_beds_used_covid" and "inpatient_beds".
- `adult_icu_bed_covid_utilization`
  Percentage of total staffed adult ICU beds currently utilized by patients who have suspected
  or confirmed COVID-19 in this state. This number only accounts for hospitals in the state that
  report both "staffed_icu_adult_patients_confirmed_and_suspected_covid" and "total_staffed_adult_icu_beds" fields.
- `adult_icu_bed_covid_utilization_coverage`
  Number of hospitals reporting both both "staffed_icu_adult_patients_confirmed_and_suspected_covid"
  and "total_staffed_adult_icu_beds".
- `adult_icu_bed_covid_utilization_numerator`
  Sum of "staffed_icu_adult_patients_confirmed_and_suspected_covid" for hospitals reporting both
  "staffed_icu_adult_patients_confirmed_and_suspected_covid" and "total_staffed_adult_icu_beds".
- `adult_icu_bed_covid_utilization_denominator`
  Sum of "total_staffed_adult_icu_beds" for hospitals reporting both
  "staffed_icu_adult_patients_confirmed_and_suspected_covid" and "total_staffed_adult_icu_beds".
- `adult_icu_bed_utilization`
  Percentage of staffed adult ICU beds that are being utilized in this state. This number only
  accounts for hospitals in the state that report both "staffed_adult_icu_bed_occupancy" and "total_staffed_adult_icu_beds" fields.
- `adult_icu_bed_utilization_coverage`
  Number of hospitals reporting both both "staffed_adult_icu_bed_occupancy" and
  "total_staffed_adult_icu_beds".
- `adult_icu_bed_utilization_numerator`
...
- `adult_icu_bed_utilization_denominator`
  ...
  "staffed_adult_icu_bed_occupancy" and "total_staffed_adult_icu_beds".
- `reporting_cutoff_start`
  Look back date start - The latest reports from each hospital is summed for this report
...
CREATE TABLE `covid_hosp_state_daily` (
  ...
  `total_pediatric_patients_hospitalized_confirmed_suspected_covid` INT,
  `total_pediatric_patients_hosp_confirmed_suspected_covid_coverage` INT,
  ...
  `adult_icu_bed_utilization_numerator` INT,
  `adult_icu_bed_utilization_denominator` INT,
  `reporting_cutoff_start` INT NOT NULL,
  PRIMARY KEY (`id`),
  -- for uniqueness
  -- for fast lookup of most recent publication date for a given state and week
  UNIQUE KEY `issue_by_state_and_date` (`state`, `reporting_cutoff_start`, `publication_date`),
  -- for fast lookup of for a given state and issue
  KEY `date_by_issue_and_state` (`publication_date`, `state`, `reporting_cutoff_start`),
  -- for fast lookup of all states for a given date and issue
  KEY `state_by_issue_and_date` (`publication_date`, `reporting_cutoff_start`, `state`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;