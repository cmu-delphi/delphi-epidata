...
class QueryBuilder:
    ...
    def apply_as_of_filter(self, history_table: str, as_of: Optional[int]) -> "QueryBuilder":
        if as_of is not None:
            ...
            sub_fields = "max(issue) max_issue, time_type, time_value, `source`, `signal`, geo_type, geo_value, signal_key_id, geo_key_id"
            sub_group = "time_type, time_value, signal_key_id, geo_key_id"
            alias = self.alias
