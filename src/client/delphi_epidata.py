...
class Epidata:
    ...
    def afhsb(auth, locations, epiweeks, flu_types):
        ...
        for flu_type in flu_types:
            if flu_type not in valid_flu_types:
    ...
    @staticmethod
    def covidcast(data_source, signals, time_type, geo_type, time_values, geo_value, as_of=None, issues=None, lag=None, **kwargs):
        """Fetch Delphi's COVID-19 Surveillance Streams"""
    ...
    @staticmethod
    def covidcast_nowcast(data_source, signals, sensor_names, time_type, geo_type, time_values,
                          geo_value, as_of=None, issues=None, lag=None, **kwargs):
        """Fetch Delphi's COVID-19 Nowcast sensors"""
        # Check parameters
        if data_source is None or signals is None or time_type is None or geo_type is None \
                or time_values is None or geo_value is None or sensor_names is None:
