  ...
  */
  ...
  Epidata = (function() {
    ...
    class Epidata {
      ...
      static covidcast(callback, data_source, signals, time_type, geo_type, time_values, geo_value, as_of, issues, lag, format) {
        var params;
        // Check parameters
      ...
      static covid_hosp(callback, states, dates, issues) {
        var params;
        // Check parameters
