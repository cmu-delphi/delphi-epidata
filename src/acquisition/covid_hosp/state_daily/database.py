...
class Database(BaseDatabase):
    ...
    ORDERED_CSV_COLUMNS = [
        ...
        # this is correct; csv header is irregular
        Columndef('previous_day_admission_adult_covid_suspected_60_69', 'previous_day_admission_adult_covid_suspected_60_69', int),
