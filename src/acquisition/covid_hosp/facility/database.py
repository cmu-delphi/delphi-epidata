...
class Database(BaseDatabase):
  ...
  ORDERED_CSV_COLUMNS = [
    ...
    ('staffed_adult_icu_bed_occupancy_7_day_sum', 'staffed_adult_icu_bed_occupancy_7_day_sum', int),
    ...
    # added by healthdata.gov May 3, 2021
    ('hhs_ids',
     'hhs_ids', str),
    ...
    # unknown when these additions were made
    ...
    ('geocoded_hospital_address',
     'geocoded_hospital_address', str), # varchar(32)
