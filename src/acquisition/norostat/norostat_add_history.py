...
from . import norostat_raw, norostat_sql
...
def main():
    ...
    print(
        'Successfully uploaded the following snapshots, with the count indicating the number of data-table versions found inside each snapshot \
            (expected to be 1, or maybe 2 if there was a change in capitalization; 0 indicates the NoroSTAT page was not found within a snapshot directory); \
                just "Counter()" indicates no snapshot directories were found:',
