...
class AcquisitionTests(unittest.TestCase):
    ...
    def test_acquire_dataset(self):
        ...
        with self.subTest(name="first acquisition"), patch.object(
            Network,
            "fetch_metadata",
            return_value=self.test_utils.load_sample_metadata(),
        ) as mock_fetch_meta, patch.object(
            Network,
            "fetch_dataset",
            side_effect=[
        ...
        with self.subTest(name="second acquisition"), patch.object(
            Network,
            "fetch_metadata",
            return_value=self.test_utils.load_sample_metadata(),
        ) as mock_fetch_meta, patch.object(
