...
class DengueSensorsTest(BasicIntegrationTest):
    """Basic integration tests for dengue_sensors endpint."""

    def setUp(self) -> None:
        """Perfor per-test setup."""
    ...
    def test_dengue_sensors(self):
        ...
        self.cnx.commit()
        response = self.epidata.dengue_sensors(auth="sensors_key", names="ght", locations="ag", epiweeks="201432")
        self.assertEqual(
            response,
            {
