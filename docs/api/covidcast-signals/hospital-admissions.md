...
> **Heads up:** This COVIDcast source is part of the legacy V4 API, which is being phased out. An actively maintained equivalent is available in V5 under the source `claims_inpatient`. See the [V4 to V5 Migration Guide](../v5_migration.md) for full details.
{: .warning }
