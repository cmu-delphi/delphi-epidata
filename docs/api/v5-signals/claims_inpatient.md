...
Geographic coverage is broader. V4 served nation, state, county, HRR, and MSA. V5 adds HHS regions, census divisions, and census regions.
...
Claims cover insured patients of participating providers and do not represent uninsured populations. Because provider submission schedules vary, counts for recent days are incomplete and revise upward. Local coding practices can also affect comparability across locations.
